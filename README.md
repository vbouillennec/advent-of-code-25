...
```bash
git clone git@github.com:vbouillennec/advent-of-code-25.git
```

#### Via HTTPS

```bash
git clone https://github.com/vbouillennec/advent-of-code-25.git
```
...
inspired by [Adrien NF](https://github.com/adrien-nf/advent-of-code-2025)